...
const ShipToDetails = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setInvoiceData({
      ...invoiceData,
      shipTo: { name, address, GSTIN, state, stateCode, pinCode },
    });
    handleNextForm();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input
              ...
              defaultValue={
                invoiceData.shipToName == "" ? name : invoiceData.shipToName
              }
              type="text"
              id="name"
          ...
          <div className="space-y-2">
            <label
              htmlFor="GSTIN"
              className="block text-sm font-medium text-gray极700"
            >
              GSTIN
            </label>
            <input
              ...
              defaultValue={
                invoiceData.shipToGSTIN == "" ? GSTIN : invoiceData.shipToGSTIN
              }
              type="text"
              id="GSTIN"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              defaultValue={
                invoiceData.shipToState == "" ? state : invoiceData.shipToState
              }
              type="text"
              id="state"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
